...
- **Vertrauen:** Versiegelte Ideen machen Schönfärberei und gelöschte Fehlprognosen unmöglich (*Ideas stay*).
- **Umsatz pro Idee:** Jeder Ideen-Trade erzeugt Gebühren, ohne Payment for Order Flow.

## 3. Einnahmequellen (in der App abgebildet)
...
| **Copy-Trading** | Elite-Funktion | Plattformanteil an kopierten Portfolios |
| **Zinsmarge auf Guthaben** | im Business-Dashboard modelliert | Kundengeld verzinst anlegen, Teil weitergeben |
| **B2B / Partner** | – | Charts, AI und Ideen-Börse an Banken und Medien lizenzieren |

**Preisgestaltung – umsatzstark und fair:** Pro ist die empfohlene Mitte, Elite und die AI-Tarife setzen den Anker nach oben. Jahresabos mit sichtbarer Ersparnis, Tagespreis-Angabe neben dem Gesamtpreis, Add-ons einzeln zubuchbar. Alle Kosten stehen im Preisverzeichnis und vor jeder Order im Ticket (Ordergebühr, Ideen-Gebühr, Spread). Versteckte Kosten wären bei Finanzdienstleistungen rechtswidrig (MiFID II, UWG, PAngV) und würden das wichtigste Kapital eines Brokers zerstören: Vertrauen.
...
Das **Business-Dashboard** in der App rechnet das live mit Schiebereglern durch (Nutzer, Conversion, Jahresabos, Trades, Ideen-Anteil, Guthaben, Zinsmarge, Bewertungs-Multiple) und zeigt, ab wie vielen Nutzern die Milliarden-Bewertung erreicht wäre.

## 5. Weg zum echten Handel (Pflicht vor echtem Geld)
