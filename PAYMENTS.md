...
- **Gründer-Deal** (Einmalzahlung, kein Abo, je 100 Plätze per Stripe-Limit): Pro 12 Monate für 49 € und AKYTEX AI 12 Monate für 199 €. Banner auf der Startseite und im Tarif-Fenster; nach der Zahlung ist der Tarif 12 Monate aktiv und endet automatisch. Links in `js/config.js` unter `stripe.founder` – leere Links blenden den Deal aus. Marketing-Texte: `MARKETING.md`.
